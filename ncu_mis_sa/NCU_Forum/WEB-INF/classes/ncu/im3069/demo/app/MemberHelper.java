 ...
 /**
    ...
    public JSONObject create(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `forum`.`member`(`name`, `email`, `password`)"
                    + " VALUES(?, ?, ?)";
            ...
            pres.setString(3, md5.encode(password));
    ...
    public JSONObject update(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `forum`.`member` SET `name` = ? ,`password` = ? WHERE `email` = ?";
            /** 取得所需之參數 */
            String name = m.getName();
            String email = m.getEmail();
            String password = m.getPassword();
            ...
            pres = conn.prepareStatement(sql);
            pres.setString(1, name);
            pres.setString(2, md5.encode(password));
